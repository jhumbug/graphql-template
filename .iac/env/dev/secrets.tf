...
resource "aws_kms_key" "ssm" {
  description             = "ssm parameters key for ${local.product}"
  ...
  "Statement": [
    {
      ...
      "Resource": "arn:aws:ssm:${var.aws_region}:${data.aws_caller_identity.current.account_id}:parameter/${var.app}/${var.environment}/*"
    }
  ]
}
EOF
